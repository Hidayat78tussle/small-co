...
const LoginForm = ({ onLogin }) => {
  ...
  const handleMicrosoftSignIn = () => {
    ...
    navigate("/financial-data"); // Redirect to Financial Data page
  };
...
//     navigate("/contact-form"); // Navigate to the initial page after login
//   };
...
//             type="button"
//             className="btn btn-outline-secondary w-100 d-flex align-items-center justify-content-center mb-2"
//             onClick={handleMicrosoftSignIn} // Trigger login and navigate
//           >
//             <i className="fab fa-microsoft text-primary me-2"></i> Sign in with
//             Microsoft
//           </button>
